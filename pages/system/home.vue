        ...
        <div class="data-box">
          ...
          <div class="home-operate">
            <el-row>
              ...
              <el-button icon="el-icon-upload" class="github-bg" @click="goLinks('https://github.com/buxia97/RuleApi')">开源地址</el-button>
              <el-button  class="money-bg" icon="el-icon-thumb" @click="goLinks('https://www.ruletree.club/sponsor.html')">赞助开发者</el-button>
            </el-row>
          </div>
        </div>
      </el-col>
